<html>
    ...
    <body class="head">
        ...
        <h3 id="p1" class="p4">I know there's a proverb which that says 'To err is human,' but a human error is nothing to what a computer can do if it tries
</h3>
        
        <div class="p6">
        
        <button id="p2"><a href='6.php' onclick='var x=document.getElementById("in").value;if(x.length==0){window.alert("PLEASE ENTER YOUR REVIEW");return false;}else return true;' >Next Page</a></button>
