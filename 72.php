<html>
    ...
    <body class="head">
        ...
        <h3 id="p1" class="p4">That's sad. How plastic and artificial life has become. It gets harder and harder to find something real." Nin interlocked his fingers, and stretched out his arms. "Real love, real friends, real body parts
</h3>
        ...
        <button id="p2"><a href='7.php' onclick='var x=document.getElementById("in").value;if(x.length==0){window.alert("PLEASE ENTER YOUR REVIEW");return false;}else return true;' >Next Page</a></button>
