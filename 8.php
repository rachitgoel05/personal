<html>
    ...
    <body class="head">
        ...
        <h3 id="p1" class="p4">"Anyone who has never made a mistake has never tried anything new."
</h3>
        ...
        <button id="p2"><a href='57.php' onclick='var x=document.getElementById("in").value;if(x.length==0){window.alert("PLEASE ENTER YOUR REVIEW");return false;}else return true;' >Next Page</a></button>
