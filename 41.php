<html>
    ...
    <body class="head">
        ...
        <h3 id="p1" class="p4">It's only after you've stepped outside your comfort zone that you begin to change, grow, and transform living fully in the present
</h3>
        ...
        <button id="p2"><a href='48.php' onclick='var x=document.getElementById("in").value;if(x.length==0){window.alert("PLEASE ENTER YOUR REVIEW");return false;}else return true;' >Next Page</a></button>
